...
class HertzMusic extends StatefulWidget {
  const HertzMusic({Key? key}) : super(key: key);

  @override
  State<HertzMusic> createState() => _HertzMusicState();
}

bool isLoading = true;

class _HertzMusicState extends State<HertzMusic> {
  void initState() {
    super.initState();
    isLoading = true;
      ...
      body: Stack(
        children: [
          Container(
              ...
              child: WebView(
                backgroundColor: AppColors.LIGHT_ORANGE_COLOR,
                initialUrl: 'https://mysticmandala.app/audio-category-hertz/',
