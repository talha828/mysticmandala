...
class MandalaVideos extends StatefulWidget {
  const MandalaVideos({Key? key}) : super(key: key);

  @override
  State<MandalaVideos> createState() => _MandalaVideosState();
}

bool isLoading = true;

class _MandalaVideosState extends State<MandalaVideos> {
        ...
        Padding(
          ...
          child: Container(
            ...
            child: WebView(
              ...
              initialUrl: 'https://mysticmandala.app/mobile-video-gallery/',
